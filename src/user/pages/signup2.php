...
<body>
    <div class="container-fluid w-100 section1">
        <div class="row text-center">
            <div class="col-md-6 right-content" style="background-image: url('../assets/img/landpage2.jpg');">
            </div>
            <div class="col-lg-6 text-center justify-content-center left-content">
                <form class="main-form" id="multiStepForm" method="post">
                    <h3 class="form-header fw-normal py-3 text-white mt-1 mb-5"><b>DAFTAR PERUSAHAAN</b></h3>
                    <!-- Form 1 -->
                    ...
                    <!-- Terms and Condition -->
                    <div class="row">
                        <div class="alert alert-info alert-dismissible m-0 p-4">
