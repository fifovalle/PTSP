        ...
        <div class="row text-center" style="display: relative;">
            <div class="col-md-6 left-content">
                ...
                <div class="background">
                    <img class="img-desktop" src="../assets/img/desktop-view.svg" alt="">
                </div>
            </div>
            <div class="align-middle col-lg-6 text-center justify-content-center right-content">
                <form class="form" action="../../../src/admin/config/login-user.php" method="POST">
                    ...
                    <div class="form-floating my-3">
                        <input type="text" name="Nama_Pengguna_Email" class="form-control" id="floatingInput" placeholder="Masukan Nama Pengguna Atau Email" autocomplete="off">
