<form class="row form g-3" action="../../../src/admin/config/add-submission4.php" method="POST" enctype="multipart/form-data">
    <div class="col-md-12">
        <div class="container my-4" id="TitleForm">
            <h4><b>Form Kegiatan Pertahanan dan Keamanan</b></h4>
        </div>
    </div>
    ...
    <div class="container my-3" id="DataKeperluan">
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <input type="text" class="form-control my-3" id="Data_dan_Informasi_Yang_Dibutuhkan" name="Informasi_Sosial_Yang_Dibutuhkan" placeholder="Masukkan Data Informasi yang Dibutuhkan" style="height: 40px">
            </div>
            <div class="col-md-6">
                <label for="suratpengantarInput">Surat Permintaan Ditandatangani Camat atau Pejabat Setingkat</label>
                <input type="file" class="form-control my-3" id="Surat_Permintaan_Ditandatangani_Camat_atau_Pejabat_Setingkat" name="Surat_Yang_Ditandatangani_Pertahanan" style="height: 40px">
            </div>
        </div>
    </div>
