        ...
        <div class="container text-center">
            <div class="row">
                ...
                <div class="col-md-12" id="informasi">
                    <h4 class="my-3">INFORMASI KLIMATOLOGI
                        <hr>
                    </h4>
                    <div class="row pt-5 px-3">
                        <?php
                        $informasiModel = new Informasi($koneksi);
                        $dataInformasiKlimatologi = $informasiModel->tampilkanDataInformasiKlimatologi();
                        if (!empty($dataInformasiKlimatologi)) {
                            $nomorUrut = 1;
                            foreach ($dataInformasiKlimatologi as $informasiKlimatologi) {
                        ?>
                                <div class="col-md-4 mb-4 p-1" id="produk">
                                    <div class="card-product">
                                        <div class="card-info text-start ps-3 py-2">
                                            <button type="button" class="info p-0 border-0 bg-transparent" data-bs-toggle="modal" data-id="<?php echo $informasiKlimatologi['ID_Informasi']; ?>">
                                        ...
                                        <div class="card-title">
                                            <?php echo $informasiKlimatologi['Nama_Informasi']; ?>
                                        </div>
                                        <div class="card-subtitle">
                                            <?php echo $informasiKlimatologi['Deskripsi_Informasi']; ?>
                                        </div>
                                        <hr class="card-divider">
                                        <div class="d-flex card-footer justify-content-between my-4 mx-3">
                                            <div class="card-price text-start"><span>Rp</span>
                                                <?php echo number_format($informasiKlimatologi['Harga_Informasi'], 0, ',', '.'); ?>
                                            </div>
                                            <div class="card-button">
                                                <form action="../../admin/config/add-cart-information-klimatologi.php" method="POST">
                                                    <input type="hidden" name="Informasi" value="<?php echo $informasiKlimatologi['ID_Informasi']; ?>">
                                                    <input type="hidden" name="Pemilik_Informasi" value="<?php echo $informasiKlimatologi['Pemilik_Informasi']; ?>">
