<form class="row form g-3" action="../../../src/admin/config/add-submission6.php" method="POST" enctype="multipart/form-data">
    <div class="col-md-12">
        <div class="container my-4" id="TitleForm">
            <h4><b>Form Pemerintah Pusat atau Daerah</b></h4>
        </div>
    </div>
