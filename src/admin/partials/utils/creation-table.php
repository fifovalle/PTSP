<table class="tableData creationTable">
    ...
    <tbody class="tbodyData">
        ...
        $dataTransaksi = $transaksiModel->tampilkanPembuatanTransaksi();
                    ...
                    <td class="text-center flex-wrap d-flex justify-content-evenly gap-2">
                        ...
                        <div class="deskriptorContainer">
                            ...
                            <div class="iconContainerData">
                                <a class="linkData buttonCreation" data-bs-toggle="modal" data-bs-toggle="modal" data-id="<?php echo $transaksi['ID_Tranksaksi'] ?>">
                                    <span class="">
