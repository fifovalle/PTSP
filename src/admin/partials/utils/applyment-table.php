    ...
    <tbody class="tbodyData">
        ...
        ?>
                <tr class="trDataN">
                    ...
                    <td class="text-center flex-wrap d-flex justify-content-evenly gap-2">
                        <div class="deskriptorContainer">
                            ...
                            <div class="iconContainerData">
                                ...
                                <a class="linkData iconDataRight" href="javascript:void(0);" onclick="confirmDeleteServices(<?php echo $pengajuan['ID_Jasa']; ?>)">
                                    <span>
                    ...
                    <td class="text-center">Rp <?php echo number_format($pengajuan['Harga_Jasa'], 0, ',', '.'); ?></td>
                    <td class="text-center"><?php echo $pengajuan['Pemilik_Jasa']; ?></td>
                    <td class="text-center"><?php echo $pengajuan['Kategori_Jasa']; ?></td>
                    <td class="text-center">
                        <?php echo ($pengajuan['Status_Jasa'] == 'Tersedia') ? '<span class="badge text-bg-success">Tersedia</span>' : '<span class="badge text-bg-danger">Belum Tersedia</span>'; ?>
                    </td>
                </tr>
        <?php
            }
