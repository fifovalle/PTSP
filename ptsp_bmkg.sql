...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 29, 2024 at 01:49 PM
...
(75, 'Naufal', '+62 812-3652-2490', 'fifanaufal10@gmail.com', 0x363632663735653539633561632e6a7067);
...
(92, 75, NULL, NULL, NULL, NULL, NULL, NULL, 'Ditolak', 'Kurang', 1, NULL, NULL, '2024-04-29 17:26:45');
...
(185, NULL, 16, NULL, 18, NULL, 92, NULL, 1, 100000, NULL, NULL, NULL, NULL, NULL, '2024-04-29 17:26:23', 'Belum Disetujui', 'Sedang Ditinjau');
...
--
ALTER TABLE `kegiatan_bencana`
  MODIFY `ID_Bencana` int(16) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=76;
...
--
ALTER TABLE `pengajuan`
  MODIFY `ID_Pengajuan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=93;
...
--
ALTER TABLE `transaksi`
  MODIFY `ID_Tranksaksi` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=186;
